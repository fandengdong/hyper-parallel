...
def _apply_activation_checkpointing(
    ...
    Args:
        ...
        enable_compile: Whether the wrapped regions will be compiled.
        swap_inputs: Whether checkpoint inputs should be offloaded.
        selection: Optional layer-selection declaration. When its ``source`` is
            ``"model_adapter_safe_regions"`` the model adapter owns the set of
            safely recomputable regions and the mode-specific wrappers below are
            bypassed.
    """
