...
def get_fully_shard_units(model: nn.Module) -> List[FSDPUnit]:
    ...
    Args:
        model (nn.Module): Root of the module tree to inspect.
    ...
    for module_name, module in get_cells_and_names(model):
