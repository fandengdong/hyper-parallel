...
# level; ``adapter_spec`` is a pure-stdlib leaf DTO module (dataclasses /
# typing only) consumed by activation checkpointing; ``registry`` is the
# planner's function-level adapter lookup. All stay acyclic; every other
